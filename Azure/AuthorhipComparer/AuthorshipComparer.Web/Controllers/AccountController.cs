    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // var callbackUrl = userId.Action("ConfirmEmail", "Account", new { userId = user.Id, code = code }, protocol: Request.userId.Scheme);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                // var callbackUrl = userId.Action("ResetPassword", "Account", new { userId = user.Id, code = code }, protocol: Request.userId.Scheme);		
